...
def getJson(page, keyword):
    data = '{"q":"blackberry","search":"提交","tab":"all","sst":"1","n":20,"buying":"buyitnow","m":"api4h5","token4h5":"","abtest":"37","wlsort":"37","page":1}'
    sign,t = get_sign(data)
    url =   'https://acs.m.taobao.com/h5/mtop.taobao.wsearch.h5search/1.0/?jsv=2.3.16&appKey=12574478&t=1557488699450&sign=3e5ad6607876c76e3bbbae01b0c98389&api=mtop.taobao.wsearch.h5search&v=1.0&H5Request=true&ecode=1&AntiCreep=true&AntiFlool=true&type=jsonp&dataType=jsonp&callback=mtopjsonp1'\
            '&t='+ t + '&sign='+ sign + '&data=' + quote(data)
    print(url)
...
def get_sign(data):
    ...
    sign = hashlib.md5()
    datas = token + '&' + t + '&' + appkey + '&' + quote(data)
